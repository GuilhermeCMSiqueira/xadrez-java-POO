...
0) Criação da classe Program do programa principal no pacote application.
...
11) Tratamento de exceções vistas nos movimentos e método para limpar a tela e deixar o andamento do programa mais limpo.
...
15) Implementação dos movimentos do rei, utilizando os conceitos de polimorfismo e encapsulamento.
